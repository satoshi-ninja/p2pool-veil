...
BLOCK_EXPLORER_URL_PREFIX='https://explorer.veil-project.com/block/'
ADDRESS_EXPLORER_URL_PREFIX='https://explorer.veil-project.com/address/'
TX_EXPLORER_URL_PREFIX='https://explorer.veil-project.com/tx/'
